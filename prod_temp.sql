    ...
    CASE
        WHEN (
            EXISTS (
                ...
                WHERE
                    tx_ticket_terr_opr_1.pic_id  = tx_user_mobile_management.tx_user_mobile_management_id 
...
FROM
    ...
    JOIN (
        SELECT
            tx_location_device_1.deviceudid  AS deviceudid,
    ...
    JOIN (
        ...
        FROM
            wfm_schema.tx_ticket_terr_opr tx_ticket_terr_opr_1
    ) tx_ticket_terr_opr ON tx_ticket_terr_opr.pic_id = tx_user_mobile_management.tx_user_mobile_management_id
WHERE
