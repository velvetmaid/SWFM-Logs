...
-- 
-- 
-- wfm_schema.vw_user_mobile_absen_location source
CREATE
...
-- 
-- 
-- wfm_schema.vw_user_mobile_ticket_status_count1 source
CREATE
OR REPLACE VIEW wfm_schema.vw_user_mobile_ticket_status_count1 AS
SELECT
    a.status,
    a.pic_id,
    a.created_at,
