...
from
    ...
    inner join wfm_schema.tx_cmsite_header tch on tumm.tx_user_mobile_management_id :: varchar = tch.pic_id
group by
    tumm.tx_user_mobile_management_id -- Query 2: Count tickets per employee from tx_ticket_terr_opr
select
    tumm.employee_name,
    count(*)
from
    wfm_schema.tx_user_mobile_management tumm
    inner join wfm_schema.tx_ticket_terr_opr tto on tumm.tx_user_mobile_management_id :: varchar = tto.pic_id
group by
    tumm.tx_user_mobile_management_id -- Query 3: Count tickets per employee from tx_pm_ticket_site
select
    tumm.employee_name,
    count(*)
from
    wfm_schema.tx_user_mobile_management tumm
    inner join wfm_schema.tx_pm_ticket_site tpts on tumm.tx_user_mobile_management_id :: varchar = tpts.pic_id
group by
    tumm.tx_user_mobile_management_id -- Query 4: Union of ticket counts from different sources
SELECT
    tumm.tx_user_mobile_management_id,
    tumm.employee_name,
    'INAP' AS source,
...
GROUP BY
    tumm.tx_user_mobile_management_id,
    tumm.employee_name -- Query 5: Combined ticket counts from different sources
SELECT
    combined_ticket.tx_user_mobile_management_id,
    combined_ticket.employee_name,
    SUM(
...
FROM
    (
        ...
        FROM
            wfm_schema.tx_user_mobile_management tumm
            INNER JOIN wfm_schema.tx_ticket_terr_opr inap ON tumm.tx_user_mobile_management_id :: varchar = inap.pic_id
        GROUP BY
            tumm.tx_user_mobile_management_id,
            tumm.employee_name
        UNION
        ...
        FROM
            wfm_schema.tx_user_mobile_management tumm
            INNER JOIN wfm_schema.tx_cmsite_header sva ON tumm.tx_user_mobile_management_id :: varchar = sva.pic_id
        GROUP BY
            tumm.tx_user_mobile_management_id,
            tumm.employee_name
        UNION
        ...
        FROM
            wfm_schema.tx_user_mobile_management tumm
            INNER JOIN wfm_schema.tx_pm_ticket_site pm ON tumm.tx_user_mobile_management_id :: varchar = pm.pic_id
        GROUP BY
            tumm.tx_user_mobile_management_id,
            tumm.employee_name
        UNION
        ...
        FROM
            wfm_schema.tx_user_mobile_management tumm
            INNER JOIN wfm_schema.ticket_technical_support fna ON tumm.tx_user_mobile_management_id :: varchar = fna.pic_id
        GROUP BY
            tumm.tx_user_mobile_management_id,
            tumm.employee_name
    ) AS combined_ticket
